  ...
  <div class="container home" data-theme="dark">
    <div class="grid">
      ...
      <div class="main animate fade delay-8">
          <h1><span>The <b>Smarter Blockchain</b></span> <span>with Account-Based Programmability <small style="display: block;">- Xahau Launch Alliance, 2023</small></span></h1>
      ...
      <div class="developers">
        ...
        <div class="devbox animate fade delay-10">
            ...
            <a style="margin-bottom: 8px;" href="https://builder.xahau.network" role="button" class="primary btnsm">Hooks builder <Hammer :size="20" :stroke-width="2.5" /></a>
            <a style="margin-bottom: 8px;" href="https://docs.xahau.network/readme-1" role="button" class="primary btnsm">Hooks docs <FileCode :size="20" :stroke-width="2.5" /></a>
